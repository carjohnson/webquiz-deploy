...
//     console.log('*** /backup auth check:',
//       'keyProvided=', !!req.get('x-backup-key'),
//       'keyExpectedSet=', !!process.env.BACKUP_API_KEY,
//       'valid=', hasValidBackupKey(req));
//     if (hasValidBackupKey(req)) {
//       return next();
//     }
//   }
