(self["webpackChunk"] = self["webpackChunk"] || []).push([["vendors-node_modules_cornerstonejs_dicom-image-loader_dist_esm_decodeImageFrameWorker_js"],{
...
function postProcessDecodedPixels(imageFrame, options, start, decodeConfig) {
    ...
    if (type && options.preScale.enabled && !disableScale) {
        ...
        invalidType = !(0,_shared_getPixelDataTypeFromMinMax__WEBPACK_IMPORTED_MODULE_14__.validatePixelDataType)(minAfterScale, maxAfterScale, type);
    }
    if (type && !invalidType) {
