"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["vendors-node_modules_cornerstonejs_tools_dist_esm_workers_polySegConverters_js"],{
...
/* harmony import */ var _kitware_vtk_js_Common_DataModel_ImageData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @kitware/vtk.js/Common/DataModel/ImageData */ "../../../node_modules/@kitware/vtk.js/Common/DataModel/ImageData.js");
...
/* harmony import */ var _icr_polyseg_wasm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @icr/polyseg-wasm */ "../../../node_modules/@icr/polyseg-wasm/dist/index.js");
...
/* harmony import */ var _utilities_boundingBox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utilities/boundingBox */ "../../../node_modules/@cornerstonejs/tools/dist/esm/utilities/boundingBox/index.js");
/* harmony import */ var _utilities_math_polyline__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utilities/math/polyline */ "../../../node_modules/@cornerstonejs/tools/dist/esm/utilities/math/polyline/index.js");
/* harmony import */ var _utilities_planar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utilities/planar */ "../../../node_modules/@cornerstonejs/tools/dist/esm/utilities/planar/index.js");
...
const polySegConverters = {
    ...
    async initializePolySeg(progressCallback) {
        ...
        this.polySegInitializingPromise = new Promise((resolve) => {
            this.polySeg = new _icr_polyseg_wasm__WEBPACK_IMPORTED_MODULE_4__["default"]();
            this.polySeg
                .initialize({
    ...
    async convertContourToVolumeLabelmap(args, ...callbacks) {
        const [progressCallback] = callbacks;
        const polySeg = await new _icr_polyseg_wasm__WEBPACK_IMPORTED_MODULE_4__["default"]();
        ...
        const imageData = _kitware_vtk_js_Common_DataModel_ImageData__WEBPACK_IMPORTED_MODULE_2__["default"].newInstance();
        imageData.setDimensions(dimensions);
        imageData.setOrigin(origin);
        imageData.setDirection(direction);
        imageData.setSpacing(spacing);
        const scalarArray = _kitware_vtk_js_Common_Core_DataArray__WEBPACK_IMPORTED_MODULE_3__["default"].newInstance({
            name: 'Pixels',
        ...
        for (const index of segmentIndices) {
            ...
            for (const annotation of annotations) {
                ...
                const bounds = (0,_utilities_boundingBox__WEBPACK_IMPORTED_MODULE_9__.getBoundingBoxAroundShapeWorld)(polyline);
                ...
                const { projectedPolyline, sharedDimensionIndex } = (0,_utilities_math_polyline__WEBPACK_IMPORTED_MODULE_10__.projectTo2D)(polyline);
                const holes = holesPolyline?.map((hole) => {
                    const { projectedPolyline: projectedHole } = (0,_utilities_math_polyline__WEBPACK_IMPORTED_MODULE_10__.projectTo2D)(hole);
                ...
                voxels.forEach(({ pointIJK }) => {
                    ...
                    isInObject: (pointLPS) => {
                        ...
                        const isInside = (0,_utilities_math_polyline__WEBPACK_IMPORTED_MODULE_10__.containsPoint)(projectedPolyline, point2D, {
                            holes,
                        });
                        return isInside;
                    },
    ...
    async convertSurfacesToVolumeLabelmap(args, ...callbacks) {
        ...
        const targetImageData = _kitware_vtk_js_Common_DataModel_ImageData__WEBPACK_IMPORTED_MODULE_2__["default"].newInstance();
        ...
        const outputVolumesInfo = results.map((result) => {
            ...
            const volume = _kitware_vtk_js_Common_DataModel_ImageData__WEBPACK_IMPORTED_MODULE_2__["default"].newInstance();
    ...
    getSurfacesAABBs({ surfacesInfo }) {
        ...
        for (const { points, id } of surfacesInfo) {
            const aabb = (0,_utilities_math_polyline__WEBPACK_IMPORTED_MODULE_10__.getAABB)(points, { numDimensions: 3 });
            aabbs.set(id, aabb);
        }
        return aabbs;
    },
        ...
        try {
            for (const [index, planeInfo] of planesInfo.entries()) {
                ...
                for (const polyDataInfo of surfacesInfo) {
                    ...
                    const aabb3 = surfacesAABB.get(id) || (0,_utilities_math_polyline__WEBPACK_IMPORTED_MODULE_10__.getAABB)(points, { numDimensions: 3 });
                    if (!surfacesAABB.has(id)) {
                        surfacesAABB.set(id, aabb3);
                    }
                    const { minX, minY, minZ, maxX, maxY, maxZ } = aabb3;
                    const { origin, normal } = planes[0];
                    if (!(0,_utilities_planar__WEBPACK_IMPORTED_MODULE_11__.isPlaneIntersectingAABB)(origin, normal, minX, minY, minZ, maxX, maxY, maxZ)) {
                        continue;
                    }
...
//# sourceMappingURL=vendors-node_modules_cornerstonejs_tools_dist_esm_workers_polySegConverters_js.js.map